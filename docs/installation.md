...
Currently, this project is built as an RPM package for RHEL8 and later. The RPM will install the binaries to `/opt/dans.knaw.nl/dd-virus-scan` and the
configuration files to `/etc/opt/dans.knaw.nl/dd-virus-scan`.
